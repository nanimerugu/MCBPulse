...
export const loadExamsAccess = (requestedBranchId: string | undefined, module: string, action: Action) =>
  loadModuleAccess(requestedBranchId, EXAMS_FLAG, module, action);
export const requireExamsAccessForAction = (branchId: string | undefined, module: string, action: Action) =>
  requireModuleAccessForAction(branchId, EXAMS_FLAG, module, action);

export const loadFilesAccess = (requestedBranchId: string | undefined, module: string, action: Action) =>
  loadModuleAccess(requestedBranchId, FILES_FLAG, module, action);
export const requireFilesAccessForAction = (branchId: string | undefined, module: string, action: Action) =>
  requireModuleAccessForAction(branchId, FILES_FLAG, module, action);

export const loadReportingAccess = (requestedBranchId: string | undefined, module: string, action: Action) =>
